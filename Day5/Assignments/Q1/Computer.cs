...
The final price of the selected device will depend on the type of processor and any 
additional accessories added to the purchase. To facilitate this process, 
an application will be used to gather input from the user regarding their 
preferred processor type and accessories, 
and subsequently calculate the total price of the selected device.
...
In class Computer, implement the below-given properties.
  ...
  HardDiskSize
    int
  GraphicCard
In class Desktop, implement the below-given properties and
 method and also inherit the class Computer.
    Data Type
   Property Name
    int
  MonitorSize
...
To calculate the price of the desktop, the processor and 
other accessories prices are given below.
In class Laptop, implement the below-given properties and 
method and also inherit the class Computer.
    Data Type
   Property Name
    int
...
To calculate the price of the laptop, the processor and other accessories 
...
Inheritance is a mechanism in object-oriented programming that allows a class to inherit properties and behaviors from a parent class, thus avoiding code duplication and promoting code reuse.
Sample Input 1:
1.Desktop
2.Laptop
Choose the option
